...
class CategoryRepo {
  ...
  Future<Response> getSubCategoryList(String parentID, [int storeId]) async {
    return await apiClient.getData(
        '${AppConstants.SUB_CATEGORY_URI}$parentID${storeId != null ? "/$storeId" : ""}');
  }
  ...
  Future<Response> getSearchData(String query, String categoryID, bool isStore, String type,String childSubCategoryId,String subCategoryId) async {
    return await apiClient.getData(
      '${AppConstants.SEARCH_URI}${isStore ? 'stores' : 'items'}/search?name=$query&category_id=$categoryID&type=$type&offset=1&limit=50&child_sub_category_id=$childSubCategoryId&sub_category_id=$subCategoryId',
    );
  }
