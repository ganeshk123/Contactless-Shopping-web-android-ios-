...
class _PaginatedListViewState extends State<PaginatedListView> {
  ...
  void _paginate() async {
    ...
    if (_offset < pageSize && !_offsetList.contains(_offset+1)) {
      ...
      widget.scrollController.animateTo(widget.scrollController.position.maxScrollExtent+60, duration: Duration(milliseconds: 50), curve: Curves.easeIn);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      (ResponsiveHelper.isDesktop(context) && widget.scrollController.position.maxScrollExtent !=
            widget.scrollController.offset) ? SizedBox() : Center(child: Padding(
