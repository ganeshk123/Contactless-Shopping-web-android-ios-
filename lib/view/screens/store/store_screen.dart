...
class _StoreScreenState extends State<StoreScreen> {
  ...
  void initState() {
    ...
    Get.find<StoreController>()
        .getStoreItemList(widget.store.id, 0, 1, 'all', false);
  }
              ...
              ? CustomScrollView(
                  ...
                  slivers: [
                    ...
                    (storeController.subCategoryList != null &&
                                    ...
                                    child: Container(
                                      padding: EdgeInsets.only(
                                        left: index == 0
                                            ...
                                            : Dimensions.PADDING_SIZE_SMALL,
                                        right: index ==
                                                storeController.subCategoryList
                                                        .length -
                                                    1
                                            ? Dimensions.PADDING_SIZE_LARGE
                                            : Dimensions.PADDING_SIZE_SMALL,
                        ...
                        : SliverToBoxAdapter(child: SizedBox()),
                    (storeController.subCategoryChildList != null &&
                            storeController.subCategoryIndex != 0)
                        ? SliverPersistentHeader(
                            pinned: true,
                            delegate: SliverDelegate(
                              child: Center(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      onTap: () => storeController
                                          .setSubCategoryChildIndex(index),
                                      child: Container(
                                        padding: EdgeInsets.only(
                                          left: index == 0
                                              ? Dimensions.PADDING_SIZE_LARGE
                    ...
                    SliverToBoxAdapter(
                      ...
                      child: PaginatedListView(
                        ...
                        storeController.getStoreItemList(
                              widget.store.id,
                              (_store != null &&
                                      _store.categoryIds.length > 0 &&
                                      storeController.categoryIndex != 0)
                                  ? storeController.subCategoryIndex != 0
                                      ? storeController
                                          .subCategoryChildList[storeController
                                              .subCategoryChildIndex]
                                          .id
                                      : storeController
                                          .subCategoryList[
                                              storeController.subCategoryIndex]
                                          .id
                                  : 0,
                              offset,
